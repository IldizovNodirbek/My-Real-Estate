...
const Contact = () => {
  return (
    <div
      className="container mx-auto p-5 bg-gray-200 mt-20 md:mt-0"
      id="contact"
    >
      <h1 className="text-3xl sm:text-4xl font-bold text-gray-800 text-center mt-14">
        Contact Us
      </h1>
      <p className="text-lg sm:text-xl text-gray-600 mb-8 mx-auto max-w-md text-center">
        If you have any questions or would like to schedule a consultation with
        one of our real estate experts, please don't hesitate to contact us.
      </p>

      <div className="flex flex-col md:flex-row gap-8 md:space-x-10">
        {/* Contact Details */}
        <div className="flex-1 mb-8 md:mb-0 px-5">
          <div className="mb-6 flex items-center">
            <FaMapMarkerAlt size={24} className="text-orange-600" />
            <span className="ml-2 text-gray-700">
              (123) 1234 Main St, Anytown USA 12345
            </span>
          </div>
          <div className="mb-6 flex items-center">
          ...
          <form className="space-y-4">
            <div>
              ...
              <input
                type="text"
                id="name"
                className="border border-orange-500 rounded-lg w-full p-3"
                required
              />
            </div>
            <div>
            ...
            <div>
              <label className="block text-gray-700 text-lg" htmlFor="phone">
                Phone
              </label>
              <input
                type="number"
            ...
            <div>
              ...
              <textarea
                id="message"
                className="border border-orange-500 rounded-lg w-full p-2"
                rows="5"
                required
              ></textarea>
            </div>
            <button
              type="submit"
              className="bg-orange-800 hover:bg-orange-500 text-white text-lg font-bold py-3 px-7 rounded-lg w-full"
            >
              Send Message
            </button>
          </form>
